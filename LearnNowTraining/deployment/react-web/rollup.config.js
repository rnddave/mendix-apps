...
export default {
    ...
    plugins: [
        mendixResolve(
            ...
            "E:/SHARED/GitHub/mendix-apps/LearnNow Training Management-main/deployment/web/cachetag.txt"
        ),
        nodePolyfills(),
        esbuild({
        ...
        generatePrecacheServiceWorker({
            deploymentDir: "E:/SHARED/GitHub/mendix-apps/LearnNow Training Management-main/deployment"
        })
    ],
};
